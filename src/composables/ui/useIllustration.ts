...
const illustrationMap: Record<string, Component> = {
  illustration_1: defineAsyncComponent(() => import('@/components/chat/illustrastions/illustration_1.vue')),
  illustration_2: defineAsyncComponent(() => import('@/components/chat/illustrastions/illustration_2.vue')),
}
