...
export const electronTemplate: ScaffoldTemplate = {
  ...
  options: [
    {
      ...
      type: 'select',
      default: 'vite-typescript',
      choices: [
        { label: 'Vite + TypeScript', value: 'vite-typescript' },
  ...
  args: (projectName, opts) => {
    return [
      projectName,
      `--template=${opts.template || 'vite-typescript'}`,
    ]
  },
}
