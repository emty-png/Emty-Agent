...
export const tauriTemplate: ScaffoldTemplate = {
  ...
  args: (projectName, opts) => {
    // Template mapping
    let templateId = opts.uiTemplate || 'vue'
    if (opts.typescript)
      templateId += '-ts'
