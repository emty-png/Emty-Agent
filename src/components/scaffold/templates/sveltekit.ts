...
export const sveltekitTemplate: ScaffoldTemplate = {
  ...
  options: [
    {
      ...
      default: 'minimal',
      choices: [
        { label: 'SvelteKit minimal', value: 'minimal' },
        { label: 'SvelteKit demo', value: 'demo' },
        { label: 'Svelte library', value: 'library' },
      ],
    },
    {
      id: 'types',
      ...
      choices: [
        ...
        { label: 'JavaScript with JSDoc', value: 'checkjs' },
    ...
    },
    {
      ...
      label: 'Add-ons',
      type: 'multiselect',
      default: ['tailwindcss', 'eslint', 'prettier', 'vitest'],
      choices: [
        ...
        { label: 'mdsvex (Markdown)', value: 'mdsvex' },
        { label: 'Paraglide (i18n)', value: 'paraglide' },
        { label: 'MCP', value: 'mcp' },
        { label: 'SvelteKit Adapter', value: 'sveltekit-adapter' },
      ],
    },
    {
      id: 'packageManager',
  ...
  args: (projectName, opts) => {
    const args = [
      ...
      '--types',
      String(opts.types || 'ts'),
      '--install',
      String(opts.packageManager || 'pnpm'),
      '--no-git',
    ]

    const selectedAddons = opts.addOns as string[]
    if (selectedAddons && selectedAddons.length > 0) {
      args.push('--add', selectedAddons.join(','))
    }
