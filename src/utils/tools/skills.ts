...
export function createSkillTools(projectPath: string | null) {
  return {
    load_skill: tool({
      description: DEFAULT_TOOL_DESCRIPTIONS.load_skill,
    ...
    load_skill_resource: tool({
      description: DEFAULT_TOOL_DESCRIPTIONS.load_skill_resource,
      inputSchema: z.object({
    ...
    create_skill: tool({
      description: DEFAULT_TOOL_DESCRIPTIONS.create_skill,
      inputSchema: z.object({
