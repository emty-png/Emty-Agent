...
import type { Attachment, ChatTab, Message } from '@/stores/chat/core/types'
...
import { normalizeContentParts, normalizeModelMessages } from '@/stores/chat/context/requestPreviewParts'
